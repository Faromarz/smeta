...
--
-- Хост: localhost
-- Время создания: Авг 12 2014 г., 07:56
...
`id` int(11) NOT NULL,
  ...
  `types_apartment_id` int(11) DEFAULT '1' COMMENT 'NUL - нет ограничений 1  - новострой 2 - вторичка',
...
INSERT INTO `works` (`id`, `count`, `unit`, `name`, `repair_ids`, `cat_arr`, `podceteg_arr`, `category_id`, `watch`, `types_apartment_id`, `room_type`, `type`, `price`) VALUES
