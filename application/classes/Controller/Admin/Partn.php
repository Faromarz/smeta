...
class Controller_Admin_Partn extends Controller_Admin_Index
{
    /**
    ...
    public function action_index()
    {
        ...
        $this->template->v_body->v_page = View::factory('admin/blocks/partn/index');
...
//        echo View::factory('profiler/stats');
 ...
 public function action_all(){
        ...
        $content = View::factory('admin/blocks/partn/all')
    ...
    public function action_create()
    {
       $this->template->styles[] = '/resources/css/admin/partners.css';
        ...
        $this->template->v_body->v_pag =  View::factory('admin/blocks/partn/edit')
    ...
    public function action_edit()
    {
        ...
        $content = View::factory('admin/blocks/partn/edit')
                ->bind("select_partner", $select_partner)
                ->bind("select_country", $select_country)
                ->bind("select_cities", $select_cities)
                ->bind("select_regions", $select_regions);
        ...
        if ( $_POST && (!$_POST['dell'] || isset($_POST['ajax'])))
        {
            try
            {
                ...
                if(!$post['city'])$post['city'] = '';
                    ...
                    $user = ORM::factory('User', $object->user_id);
                    $user->phone = $_POST['telephon'];
                    $user->save();
...
//                    $this->template->v_body->v_pag->class = ' full-content';
		parent::after();
	}
}
