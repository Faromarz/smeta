...
class Controller_Admin_Category extends Controller_Admin_Index
{
	...
	{
            $this->template->scripts[] = '/media/libs/metronic/assets/global/plugins/select2/select2.min.js';
            $this->template->scripts[] = '/media/libs/metronic/assets/global/plugins/data-tables/jquery.dataTables.min.js';
            $this->template->scripts[] = '/media/libs/metronic/assets/global/plugins/data-tables/tabletools/js/dataTables.tableTools.min.js';
            $this->template->scripts[] = '/media/libs/metronic/assets/global/plugins/data-tables/DT_bootstrap.js';
            $this->template->scripts[] = '/media/libs/metronic/assets/admin/pages/scripts/table-advanced.js';
