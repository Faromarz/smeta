...
<p class="pagination">
	...
	<?php if ($first_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($first_page)) ?>" rel="first">Первая</a>
	<?php else: ?>
		Первая
	<?php endif ?>

	<?php if ($previous_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev">Предыдущая</a>
	<?php else: ?>
		Предыдущая
	<?php endif ?>
	...
	<?php if ($next_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next">Следущая</a>
	<?php else: ?>
		<?php echo __('Next') ?>
	<?php endif ?>

	<?php if ($last_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last">Последняя</a>
	<?php else: ?>
		Последняя
	<?php endif ?>
