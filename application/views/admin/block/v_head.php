<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner">
        ...
        <div class="page-logo">
            <a href="/admin">
                <img src="/media/img/logo.png" alt="logo" class="logo-default" style="height:16px">
            </a>
...
<!--                <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 250px;"><ul class="dropdown-menu-list scroller" style="overflow: hidden; width: auto; height: 250px;" data-initialized="true">
                                    <li>
                                        <a href="#">
                ...
                <li class="dropdown dropdown-user">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        ...
                        <span class="username">логин</span>
