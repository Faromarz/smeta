...
<div class="content<?if(isset($class)):?><?=$class?><?  endif;?>">
    ...
    <? foreach ($objects as $object): ?>
                        ...
                        <td style="vertical-align: top;width: 5%;">  
                            <div class="inputBlock">
                                 <select name="categor_arr[]" multiple  style="float: none;height: 88px;">
                                    ...
                                    <!--<option value="Пробка"<?if($object->categor_arr == 32 && !empty($object->podceteg_arr) && $object->podceteg_arr == 'Пробка'):?> selected<?  endif;?>>Пробка</option>-->
        ...
        <? endforeach; ?>
    <a id="add" href="/admin/work/montcreate" style="padding-top: 10px;display: block;color: #393939;">Добавить работу</a>
