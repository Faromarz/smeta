...
function Smeta() {
    ...
    _this.rooms = {};
    _this.rooms.room = [];
    _this.rooms.repair_ebp = 2;
    _this.rooms.repair_cc = 5;
    _this.rooms.repair_nv = 7;
    ...
    _this.load = new Load(_this);// калькулятор цены
    _this.calc = new Calc(_this);// калькулятор цены
    _this.calcRoomPartner = new CalcRoomPartner(_this); // загрузка фото партнерев
...
//    _this.calcRemontMaterials = new CalcRemontMaterials(_this);
